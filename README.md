...
## Project Structure
    ...
    ├── wash_and_fold_34887            # Django project configurations
...
1. Clone this repo and `cd wash_and_fold_34887`
...
2. Clone this repo and `cd wash_and_fold_34887`
...
Admin Panel can be accessed through http://35.167.203.216:8000/admin/. Default Superuser username = root password = root
